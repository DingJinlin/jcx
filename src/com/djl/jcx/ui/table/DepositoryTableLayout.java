...
public class DepositoryTableLayout extends AbstractTableLayout<DepositoryModel, IDepositoryDao> {
    public DepositoryTableLayout() {
        super(new Table(), new DepositoryContainerGetter());
